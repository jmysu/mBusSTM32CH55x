...
#define EP_END          (EP2_ADDR + EP2_BUF_SIZE +1)
 

__xdata __at (EP0_ADDR)   uint8_t EP0_bufUSB[EP0_BUF_SIZE];     

__xdata __at (EP1_ADDR)   uint8_t EP1_bufHID[EP1_SIZE];
__xdata __at (EP1_ADDRTX) uint8_t EP1_bufHIDTX[EP1_SIZE];

__xdata __at (EP2_ADDR)   uint8_t EP2_bufCDC[EP2_SIZE];
__xdata __at (EP2_ADDRTX) uint8_t EP2_bufCDCTX[EP2_SIZE];

__xdata __at (EP_END)     uint8_t __EP_end__;
